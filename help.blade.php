...
<ol>
	<li>As a gamification system to push the entire ~21 NUS students currently enrolled in Steven's CS3233 module to work as hard as they can...</li>
	<li>As a testing platform for Steven to self-learn Laravel framework, to be subsequently taught to Steven's CS3226 students :)</li>
</ol>
</div>
<hr>
<div class="miniContest">
<h3>MC = Weekly Mini Contest (36%)</h3>
<p>9 Weekly Mini Contests, three problems in 75 minutes, using
<a href="http://algorithmics.comp.nus.edu.sg/~mooshak/cgi-bin/execute/9042797581778279" target="_blank">Mooshak.</a>
</p>
<p>(9 weeks x (3%+0.5%+0.5%)/week = 36%).</p>
<ol>
...
<div class="KattisSet">
	<h3>Kattis Set (12%)</h3>
	<p>We use <a href="https://nus.kattis.com/" target="_blank">Kattis@NUS</a> for this semester.</p>
...
<div class="achievement">
	...
	<ol>
		...
		<li>****** <b>Kattis apprentice</b>: Be in top 25 (6%)/50 (5%)/100 (4%)/150 (3%)/200 (2%)/250 (1%) of Kattis ranklist by the end of Week13 (this achievement will NOT be updated weekly as this will keep changing every week).</li>
		<li>* <strong>CodeForces Specialist</strong>: Given to student who also join CodeForces contests and attain rating of at least 1400 (Cyan color) by the end of Week13 (this achievement will NOT be updated weekly as this will keep changing every week).</li>
	</ol>
</div>
</div>
